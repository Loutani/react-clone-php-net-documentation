        ...
        <>
            ...
            <div className="layout clearfix">
                <section className="layout-content">
                    <h2 className="content-title" id="contributing-to-php">Contributing to PHP</h2>
                    ...
                    <h3 className="content-title" id="ways-to-contribute">
                        Four Best Ways to Contribute
                    </h3>

                    <ol className="content-box listed">
                        ...
                        <li>Help maintain and or translate documentation files
                            ...
                            <a href="http://doc.php.net/tutorial/">guide for contributors</a>.
                        </li>
                    </ol>

                    <h3 className="content-header" id="php-src">
                    ...
                    <h3 className="content-title" id="references">
                        Useful links for developers
                    </h3>
                    <ul className="content-box listed">
                        <li>
                            <a href="https://heap.space">lxr</a> - an online interface to the PHP source, providing search facilities useful for programmers and researchers
                        </li>
                        <li>
                            <a href="https://wiki.php.net/rfc/howto">The RFC process</a> - the process
                            by which developers can suggest and discuss new ideas with the community
                        </li>
                        <li>
                            <a href="/build-setup.php">Developer Setup Help</a> - some helpful information
                            regarding setting up a development environment for PHP
                        </li>
                        <li>
                            <a href="/mailing-lists.php">Mailing List</a> - list of general and internal mailing lists
                            used by PHP
                        </li>
                    </ul>
                ...
                <aside className="tips">
                    <div className="inner">
                        <div className="panel">
                            <div className="headline">Table of Contents</div>
                            <div className="body">
                                <ul>
